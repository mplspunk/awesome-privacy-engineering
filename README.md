...
* [Alchimista](https://github.com/Daniele-Cangi/Alchimista) - Self-hosted privacy infrastructure for document and LLM workflows, with PII detection, reversible pseudonymization, encrypted local mappings, fail-closed protection, and auditable privacy evidence.
