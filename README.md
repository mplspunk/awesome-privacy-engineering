...
* [Google Differential Privacy Library](https://github.com/google/differential-privacy) - This repository contains libraries to generate ε- and (ε, δ)-differentially private statistics over datasets. Includes the following libraries:
    * [Privacy on Beam](https://github.com/google/differential-privacy/tree/main/privacy-on-beam) - An end-to-end differential privacy framework built on top of Apache Beam.
...
* [European Data Protection Board Website Auditing Tool](https://code.europa.eu/edpb/website-auditing-tool/-/releases) - EDPB WAT is a tool to collect evidence, analyze, and generate reports regarding trackers that are being used by websites.
